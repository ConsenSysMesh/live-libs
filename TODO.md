* `web3.versions.getNetwork()` may be able to replace all the env passing (this errors with `net_version method not implemented` on my geth, will upgrade and try again)
