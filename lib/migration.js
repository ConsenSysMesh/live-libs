...
function deploy(liveLibs, web3, deployRegistryData) {
  return deployLiveLibsContracts(web3, liveLibs.isTesting()).then(function() {
    if (!deployRegistryData || !fs.existsSync(fileUtils.dataFilePath))
