    ...
    Object.keys(jsonData).forEach(function(libName) {
      ...
      promises.push(
        new Promise(function(resolve, reject) {
          ...
          return register(libName, jsonData[libName].version, contract.address, JSON.stringify(jsonData[libName].abi, jsonData[libName].thresholdWei));
        })
      );
    });
